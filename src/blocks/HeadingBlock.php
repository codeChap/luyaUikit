...
final class HeadingBlock extends BaseUikitBlock
{
    ...
    public function config()
    {
        return [
            'vars' => [
                ['var' => 'title', 'label' => Module::t('block_heading.title'), 'type' => self::TYPE_TEXT],
                ['var' => 'align', 'label' => Module::t('block_heading.align'), 'type' => self::TYPE_SELECT, 'options' => BlockHelper::selectArrayOption([
                    'uk-text-left'   => 'left',
                    'uk-text-center' => 'center',
                    'uk-text-right'  => 'right'
                    ])
                ],
                ['var' => 'size',  'label' => Module::t('block_heading.size'),  'type' => self::TYPE_SELECT, 'options' => BlockHelper::selectArrayOption([
                ...
                ['var' => 'color', 'label' => Module::t('block_heading.color'),  'type' => self::TYPE_SELECT, 'options' => BlockHelper::selectArrayOption([
                    'uk-text-muted'     => 'Muted',
